// docs/benchmarks/scripts/phase2-redis.js
//
// Phase 2 measurement: Redis Lua atomic inventory.
//
// WHAT TO OBSERVE:
//   - lock_conflict_count should be 0 (Lua eliminates all contention)
//   - order_success / total_requests should be ~99%+ (vs ~15% in Phase 1)
//   - QPS reflects the system throughput under controlled 40-VU load
...
export const options = {
    ...
    scenarios: {
        flash_sale: {
            ...
            // The key metric is success_rate (99%+ vs Phase 1's ~15%),
            // not raw QPS — the bottleneck is optimistic-lock contention,
            // not client concurrency.
            vus: 40,
            duration: '60s',
        },
    },
...
export function handleSummary(data) {
    ...
    const summary = {
        ...
        phase:          'Phase 2 — Redis Lua Atomic Inventory',
        vus:            40,
        duration:       '60s',
    ...
    console.log('\n========== PHASE 2 REDIS RESULTS ==========');
    console.log(JSON.stringify(summary, null, 2));
    console.log('============================================\n');
    console.log('Key metrics:');
    console.log(`  success_rate: ${successRate}% (expect ~99%)`);
    console.log(`  lock_conflicts: ${summary.lock_conflicts} (expect 0)`);
    console.log(`  p99_ms: ${summary.p99_ms}ms (expect < 3000ms)`);
